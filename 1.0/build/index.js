...
gallery/ghostscroll/1.0/index

*/
KISSY.add('gallery/ghostscroll/1.0/index',function(S, Node) {
    ...
    GhostScroll.prototype.bindScroll = function(scrollEl, wrapperEl) {
      ...
      return wrapperEl.on("mousewheel", (function(_this) {
        return function(ev) {
          var _temp;
          ev.halt();
          _temp = wrapperEl.scrollTop() - (ev.wheelDelta ? ev.wheelDelta : ev.delta * -120);
